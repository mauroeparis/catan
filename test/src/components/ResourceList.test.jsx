...
describe("<ResourceListContainer /> rendering", () => {
  it("should render six <li>", () => {
    const wrapper = shallow(<ResourceListContainer resources={resources} />);
  ...
  //   const wrapper = shallow(<Container resources={resources} />);
  //   // Expects the app to have exactly 5 hi children
